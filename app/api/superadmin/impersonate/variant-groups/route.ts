...
// GET /api/superadmin/variant-groups — todos los grupos globales con sus opciones
...
// POST /api/superadmin/variant-groups — crear grupo global
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Crear grupo con tenant_id = NULL → global
